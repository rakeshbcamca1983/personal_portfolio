...
let progressmysql = setInterval(() => {
  ...
  mysqlProgress.style.background = `conic-gradient(#3f396d ${
    mysqlStartValue * 3.6
  }deg, #ededed 0deg)`;
...
let progressnodejs = setInterval(() => {
  ...
  nodejsProgress.style.background = `conic-gradient(#3f396d ${
...
document.getElementById("submitBtn").addEventListener("click", function (e) {
    ...
    fetch("sendmail.php", {
        ...
        body: `name=${name}&email=${email}&mobile=${mobile}&message=${message}`
    })
